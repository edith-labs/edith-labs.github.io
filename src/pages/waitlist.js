  ...
  return (
    <Layout>
      ...
      >
        ...
        <div class='columns is-centered'>
          <div class='column is-half' style={{ marginLeft: rhythm(0.25), marginRight: rhythm(0.25) }}>
            <p>
              Hi there! Our mission at Edith Labs is to connect students with people who will
              invest in their future and help them succeed. As COVID-19 continues to impact universities
              around the world, we believe access to mentorship is more important than ever.
            </p>
            ...
            <p>
              While we want to help as many students as possible, we’re limiting the first batch
              to 50 students – please sign up for the waitlist and we’ll add you as soon as
        ...
        <div class='columns is-centered'>
          <div class='column is-one-third' style={{ textAlign: 'center', marginRight: rhythm(0.25), marginLeft: rhythm(0.25)}}>
